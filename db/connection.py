...
db/connection.py
----------------
Single-instance psycopg2 connection pool for the Sepsis Atlas.

Reads DATABASE_URL from the environment (or .env file).
Expected format:
    postgresql://user:password@host:5432/sepsis_atlas
"""
...
DATABASE_URL = os.getenv(
    "DATABASE_URL",
    "postgresql://sepsis_user:sepsis_pass@localhost:5432/sepsis_atlas",
)
